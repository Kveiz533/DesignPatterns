...
public sealed class DisconnectParserBuilder : BaseParserBuilder<DisconnectCommandBuilder>
{
    public override ICommandParser Build()
    {
        return new DisconnectParser(SubChainCommandsHead, SubChainArgumentsHead);
    }
}